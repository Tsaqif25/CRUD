...
<?php include 'navbar-admin.php'; ?> 
    <div class="col-md-10 p-5 pt-10">
        <h3>Jadwal</h3>
        <hr>
        <a href="./kelolajadwal.php" class="btn btn-primary mb-4" data-toggle="tooltip" title="Tambah Jadwal Baru"> 
        ...
        <table class="table table-striped table-bordered" id="example">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="./kelolajadwal.php?ubah=<?php echo $result['idjadwal']; ?>" class="btn btn-warning mr-3" data-toggle="tooltip" title="Edit Data">
                            <i class="fa-solid fa-pen-to-square"></i> Edit
                        </a>
                        <a href="./prosesjadwal.php?hapus=<?php echo $result['idjadwal']; ?>" class="btn btn-danger" data-toggle="tooltip" title="Hapus Data" 
